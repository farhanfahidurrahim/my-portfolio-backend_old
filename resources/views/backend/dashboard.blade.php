                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="card card-congratulation-medal">
                                <div class="card-body">
                                    ...
                                    <img src="{{ asset('backend') }}/assets/images/illustration/badge.svg"
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('backend') }}/assets/images/icons/toolbox.svg"
                                                                        alt="Toolbar svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('backend') }}/assets/images/icons/parachute.svg"
                                                                        alt="Parachute svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('backend') }}/assets/images/icons/brush.svg"
                                                                        alt="Brush svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('backend') }}/assets/images/icons/star.svg"
                                                                        alt="Star svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('backend') }}/assets/images/icons/book.svg"
                                                                        alt="Book svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('backend') }}/assets/images/icons/rocket.svg"
                                                                        alt="Rocket svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('backend') }}/assets/images/icons/speaker.svg"
                                                                        alt="Speaker svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="card card-developer-meetup">
                                <div class="meetup-img-wrapper rounded-top text-center">
                                    <img src="{{ asset('backend') }}/assets/images/illustration/email.svg"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="avatar-group">
                                        ...
                                        <div data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                            ...
                                            <img src="{{ asset('backend') }}/assets/images/portrait/small/avatar-s-6.jpg"
                                                alt="Avatar" width="33" height="33" />
                                        </div>
                                        <div data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                            data-bs-placement="bottom" title="Brandon Miles" class="avatar pull-up">
                                            <img src="{{ asset('backend') }}/assets/images/portrait/small/avatar-s-8.jpg"
                                                alt="Avatar" width="33" height="33" />
                                        </div>
                                        <div data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                            data-bs-placement="bottom" title="Daisy Weber" class="avatar pull-up">
                                            <img src="{{ asset('backend') }}/assets/images/portrait/small/avatar-s-20.jpg"
                                                alt="Avatar" width="33" height="33" />
                                        </div>
                                        <div data-bs-toggle="tooltip" data-popup="tooltip-custom"
                            ...
                            <div class="card card-browser-states">
                                ...
                                <div class="card-body">
                                    <div class="browser-states">
                                        <div class="d-flex">
                                            <img src="{{ asset('backend') }}/assets/images/icons/google-chrome.png"
                                    ...
                                    <div class="browser-states">
                                        <div class="d-flex">
                                            <img src="{{ asset('backend') }}/assets/images/icons/mozila-firefox.png"
                                    ...
                                    <div class="browser-states">
                                        <div class="d-flex">
                                            <img src="{{ asset('backend') }}/assets/images/icons/apple-safari.png"
                                    ...
                                    <div class="browser-states">
                                        <div class="d-flex">
                                            <img src="{{ asset('backend') }}/assets/images/icons/internet-explorer.png"
                                    ...
                                    <div class="browser-states">
                                        <div class="d-flex">
                                            <img src="{{ asset('backend') }}/assets/images/icons/opera.png"
