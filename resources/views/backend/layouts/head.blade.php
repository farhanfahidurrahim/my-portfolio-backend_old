...
<link rel="stylesheet" type="text/css" href="{{ asset('backend') }}/assets/css/pages/app-invoice-list.min.css">
<link rel="stylesheet" type="text/css" href="{{ asset('backend') }}/assets/css/pages/dashboard-ecommerce.min.css">
