...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen"
        href="{{ asset('backend') }}/assets/css/perfect-scrollbar.min.css" />
    <link rel="stylesheet" type="text/css" media="screen" href="{{ asset('backend') }}/assets/css/style.css" />
    <link defer rel="stylesheet" type="text/css" media="screen" href="{{ asset('backend') }}/assets/css/animate.css" />
    <script src="{{ asset('backend') }}/assets/js/perfect-scrollbar.min.js"></script>
    <script defer src="{{ asset('backend') }}/assets/js/popper.min.js"></script>
    <script defer src="{{ asset('backend') }}/assets/js/tippy-bundle.umd.min.js"></script>
    <script defer src="{{ asset('backend') }}/assets/js/sweetalert.min.js"></script>
</head>
...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased"
    ...
    @include('backend.layouts.themecustomize')
    ...
    <script src="{{ asset('backend') }}/assets/js/alpine-collaspe.min.js"></script>
    <script src="{{ asset('backend') }}/assets/js/alpine-persist.min.js"></script>
    <script defer src="{{ asset('backend') }}/assets/js/alpine-ui.min.js"></script>
    <script defer src="{{ asset('backend') }}/assets/js/alpine-focus.min.js"></script>
    <script defer src="{{ asset('backend') }}/assets/js/alpine.min.js"></script>
    <script src="{{ asset('backend') }}/assets/js/custom.js"></script>
    <script defer src="{{ asset('backend') }}/assets/js/apexcharts.js"></script>
